...
class PageForgot extends StatefulWidget {
  ...
  @override
  _PageForgetState createState() => _PageForgetState();
}

class _PageForgetState extends State<PageForgot> {
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: (state.countdown > 0)
                                    ? null
                                    : () {
                                        context.read<AccountBloc>().add(SendOtpForgetPassword(email: emailController.text));
                                      },
